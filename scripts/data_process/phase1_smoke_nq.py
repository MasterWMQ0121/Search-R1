...
def make_prompt(question: str) -> str:
    return (
        ...
        "MUST consist of exactly two tagged blocks and nothing else: one reasoning block followed "
        "by one final-answer block, as in this unrelated format example:\n"
        "<think>The retrieved evidence says the clear daytime sky is blue.</think>\n"
        "<answer>blue</answer>\n"
